...
#define SIM_SDID				*((volatile unsigned int*)0x40048024)	

// Multipurpose Clock Generator (MCG)

#define MCG_C4					*((volatile unsigned char*)0x40064003)

#define MCG_C4_DMX_32			( 1 << 7 )
#define MCG_C4_DRST_LOW			( 0 << 5 )
#define MCG_C4_DRST_MID			( 1 << 5 )
#define MCG_C4_DRST_MID_HIGH	( 2 << 5 )
#define MCG_C4_DRST_HIGH 		( 3 << 5 )
...
#define PORTC_PCR(X)			*((volatile unsigned int*)(0x4004B000 + 4 * X))
#define PORTC_PCR0 				*((volatile unsigned int*)0x4004B000)
